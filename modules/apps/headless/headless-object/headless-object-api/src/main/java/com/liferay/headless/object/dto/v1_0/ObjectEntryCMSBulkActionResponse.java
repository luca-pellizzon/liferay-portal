...
@GraphQLName(
	...
	value = "ObjectEntryCMSBulkActionResponse"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectEntryCMSBulkActionResponse")
public class ObjectEntryCMSBulkActionResponse implements Serializable {

	public static ObjectEntryCMSBulkActionResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ObjectEntryCMSBulkActionResponse.class, json);
	}

	public static ObjectEntryCMSBulkActionResponse unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.object.dto.v1_0.ObjectEntryCMSBulkActionResponse",
		name = "x-class-name"
	)
