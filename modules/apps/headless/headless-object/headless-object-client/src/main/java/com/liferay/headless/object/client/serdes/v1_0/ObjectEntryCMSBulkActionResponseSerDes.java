...
public class ObjectEntryCMSBulkActionResponseSerDes {
	...
	public static String toJSON(
		...
		if (objectEntryCMSBulkActionResponse.getIds() != null) {
			...
			for (int i = 0;
				 i < objectEntryCMSBulkActionResponse.getIds().length; i++) {

				sb.append(objectEntryCMSBulkActionResponse.getIds()[i]);

				if ((i + 1) <
						objectEntryCMSBulkActionResponse.getIds().length) {
	...
	public static Map<String, String> toMap(
		...
		if (objectEntryCMSBulkActionResponse.getIds() == null) {
			...
			map.put(
				"ids",
				String.valueOf(objectEntryCMSBulkActionResponse.getIds()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "ids")) {
				if (jsonParserFieldValue != null) {
					objectEntryCMSBulkActionResponse.setIds(
