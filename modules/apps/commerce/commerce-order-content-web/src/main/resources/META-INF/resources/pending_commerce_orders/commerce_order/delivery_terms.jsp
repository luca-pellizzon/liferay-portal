...
List<CommerceTermEntry> deliveryTermsEntries = commerceOrderContentDisplayContext.getDeliveryTermsEntries();

long deliveryCommerceTermEntryId = commerceOrder.getDeliveryCommerceTermEntryId();
%>

<portlet:actionURL name="/commerce_open_order_content/edit_commerce_order" var="editCommerceOrderDeliveryTermsActionURL" />
