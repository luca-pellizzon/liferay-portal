...
<portlet:actionURL name="/commerce_open_order_content/edit_commerce_order_external_reference_code" var="editCommerceOrderExternalReferenceCodeURL" />
...
<commerce-ui:modal-content>
	<aui:form action="<%= editCommerceOrderExternalReferenceCodeURL %>" cssClass="container-fluid container-fluid-max-xl p-0" method="post" name="fm">
		<aui:model-context bean="<%= commerceOrderContentDisplayContext.getCommerceOrder() %>" model="<%= CommerceOrder.class %>" />
