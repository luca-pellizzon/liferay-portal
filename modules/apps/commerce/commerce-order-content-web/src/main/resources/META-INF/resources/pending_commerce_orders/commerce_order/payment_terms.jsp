...
List<CommerceTermEntry> paymentCommerceTermEntries = commerceOrderContentDisplayContext.getPaymentTermsEntries();

long paymentCommerceTermEntryId = commerceOrder.getPaymentCommerceTermEntryId();
%>

<portlet:actionURL name="/commerce_open_order_content/edit_commerce_order" var="editCommerceOrderPaymentTermsActionURL" />
