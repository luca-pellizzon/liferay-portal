...
<portlet:actionURL name="/commerce_payment_methods/edit_payment_method_group_rel_qualifiers" var="editCommercePaymentMethodGroupRelQualifiersActionURL" />
	...
	<div class="row">
		<div class="col-12">
			...
			>
				<div class="row">
					<aui:fieldset markupView="lexicon">
						<aui:input checked='<%= Objects.equals(termEntryQualifiers, "all") %>' label="all-payment-terms" name="qualifiers--termEntry--" type="radio" value="all" />
